...
import UpdateTerbaru from './UpdateTerbaru';
  ...
  useEffect(() => {
    ...
    const loadData = async () => {
      try {
        ...
        // Then load all available books (no limit)
        try {
          const booksResponse = await axios.get('http://localhost:3000/api/buku/available?limit=100');
        ...
        <div className="flex-1">
          <div className="bg-white rounded-lg shadow-md p-6 mb-8">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-2xl font-bold text-gray-800">Books Available for Borrowing</h2>
